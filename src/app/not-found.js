...
export default function NotFound() {
  return (
    <div className="page-enter mx-auto flex min-h-[65vh] w-full max-w-3xl flex-col items-center justify-center px-6 text-center">
      <p className="text-sm uppercase tracking-[0.28em] text-cyan-300">404</p>
      <h1 className="mt-4 text-5xl font-black text-white md:text-7xl">Lost In The Void</h1>
